...
beautiful.init("/usr/share/awesome/themes/personal/theme.lua")
...
vicious.register(weatherwidget,vicious.widgets.weather," ${sky} ${tempf}°F ||",180,"KORD")
diskwidget=wibox.widget.textbox()
vicious.register(diskwidget,vicious.widgets.fs," /:${/ used_p}% h:${/home used_p}% ||")
wifiwidget=wibox.widget.textbox()
vicious.register(wifiwidget,vicious.widgets.wifi," WIFI:${ssid}(${link}%) ||",10,"wlp4s0")
...
--    awful.key({ modkey },            "r",     function () mypromptbox[mouse.screen]:run() end),
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -q sset Master 2dB+") awful.util.spawn("dzvol -x 1650 -y 45 -bg '#2c2e2f' -fg '#dcdccc'") end),
